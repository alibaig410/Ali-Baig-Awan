...
if(isset($_POST['submit']))
{
        ...
        $res = "UPDATE pd SET productName= '$prname',productPrice= '$prprice',productCode= '$prcode',productInstock= '$prstock',
			productDiscount= '$prdiscount',productSizes= '$prsize',productDetails= '$prdetails',/*productId= prid,*/img= '$primg'";
